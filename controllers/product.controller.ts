...
router.get('/', (req, res) => {
    ProductSchema.find((err: any, docs: any) => {
...
router.get('/:id', (req, res) => {
    ...
    ProductSchema.findById(req.params.id, (err: any, doc: any) => {
        if (!err) { res.send(doc); }
...
router.put('/:id', (req, res) => {
    ...
    ProductSchema.findByIdAndUpdate(req.params.id, { $set: prod }, { new: true }, (err: any, doc: any) => {
        if (!err) { res.send(doc); 
...
router.delete('/:id', (req, res) => {
    ...
    ProductSchema.findByIdAndRemove(req.params.id, (err: any, doc: any) => {
        if (!err) { res.send(doc); }
